...
```{bash}
#| output-fold: true
awk -F'\t' 'NR==1 || (!/scout/ && !/_dup/)' Norman/Mennen/5516_greenEyes/sub-01/ses-01/sub-01_ses-01_scans.tsv > temp_scans.tsv && mv temp_scans.tsv Norman/Mennen/5516_greenEyes/sub-01/ses-01/sub-01_ses-01_scans.tsv
```

You can also run Python code to achieve the same result:
